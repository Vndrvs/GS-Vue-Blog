...
@media (max-width: 900px) {
  .content-container {
    ...
    & .content-section {
      ...
      & h1 {
        margin: 4% 0 0 0;
        @include font-style(var(--heading-font), 800, 2em, 110%, none, var(--text-clr));
      }
      ...
      & h4 {
        margin: 4% 0 0 0;
        @include font-style(var(--heading-font), 500, 0.8rem, 20px, none, var(--text-clr));
      }
      ...
      & p {
        margin: 4% 0 0 0;
        @include font-style(var(--body-font), 400, 0.9rem, 130% !important, none, var(--text-clr));
      }
    }
  }
}
