<template>
  <el-menu :default-active="activeIndex" id="sidebar" :style="sidebarStyles">
    ...
    <el-collapse-transition>
      <div v-show="!isCollapse">
        <el-menu-item v-if="!isHome" index="home" class="sidebar-item">
          <span :class="{ 'fade-out': isCollapse }" @click="navbarClicked"
        ...
        <el-menu-item index="2" class="sidebar-item">
          <span :class="{ 'fade-out': isCollapse }" @click="navbarClicked"
            ><router-link to="/projects">PROJECTS</router-link></span
          >
        </el-menu-item>
        <el-menu-item index="3" class="sidebar-item">
          <span :class="{ 'fade-out': isCollapse }" @click="navbarClicked"
            ><router-link to="/intro">ABOUT GS</router-link></span
          >
        </el-menu-item>
        ...
        <el-menu-item index="4" class="sidebar-item">
          <span
            :class="{ 'fade-out': isCollapse }"
            id="randomizer"
            @click="(goToRandomPost(), navbarClicked())"
            >RANDOM POST</span
          >
        </el-menu-item>
      </div>
